...
/*
data x;
	input mydate yymmdd10.;	2020-11-16
	input mydate ddmmyy8.;	16/11/20		<---(diversi modi per scrivere in input le date)
	input mydate date9.;	16Apr2020
*/

/*
dlm=','		<---a volte il delimitatore può essere dlm=';' (americani)
*/